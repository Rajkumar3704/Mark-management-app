...
class CourseStudentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create course_student" do
    assert_difference("CourseStudent.count") do
      post course_students_url, params: { course_student: { c_id: @course_student.c_id, s_id: @course_student.s_id } }
    end
  ...
  test "should update course_student" do
    patch course_student_url(@course_student), params: { course_student: { c_id: @course_student.c_id, s_id: @course_student.s_id } }
